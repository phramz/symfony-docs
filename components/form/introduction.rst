...
could install the latest 2.6 version by adding the following ``require``
...
installed. If you're using Composer, you could get the latest 2.6 version
...
install the latest 2.6 version, add this to your ``composer.json``:
